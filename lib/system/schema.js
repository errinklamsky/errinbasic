module.exports = (m, env) => {
   ...
   if (setting) {
      ...
      if (!('sk_author' in setting)) setting.sk_author = '© Errin bot'
      ...
      if (!('msg' in setting)) setting.msg = 'Hi +tag 🪸\nI am an automated system Yuktap (WhatsApp Bot) that can help to do something, search and get data / information only through WhatsApp.\n\n◦ *Database* : +db\n◦ *Library* : Baileys v+version\n◦If you find an error or want to upgrade premium plan contact the owner.'
      ...
      if (!('link' in setting)) setting.link = 'https://chat.whatsapp.com/JUSOjkqUGoV7Ow5e8OFG8P'
   } else {
      global.db.setting = {
         autodownload: true,
         debug: false,
         ...
         link: 'https://chat.whatsapp.com/JUSOjkqUGoV7Ow5e8OFG8P'
      }
   }
}